...
//
//
//    protected static <M extends TimelineCollectionChange<M,T,C,K>,T extends DateMutableEntity<?>,C extends Collection<K>,K>
//    C buildFullList(Timeline<? extends T> t, TimelineCollectionChange<?,?,C,K> tlChange){
//        final List<K> ec = tlChange.getEndingChanges();
//        tlChange.onBuildMap();
//        Timeline<T> timeline = (Timeline<T>) t;
//        C toReturn = tlChange.getNewChangeFragment().get();
...
//    //==================================================================================================================
//    //==== Abstract Methods ====
//    protected abstract Supplier<C> getNewChangeFragment();
//
//    //==================================================================================================================
//    //==== Getters and Setters ====
