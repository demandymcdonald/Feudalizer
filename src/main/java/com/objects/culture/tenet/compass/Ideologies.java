...
// --- MONARCHIES ---
    ...
    public static final Ideology ABSOLUTE_MONARCHY = new Ideology(
            "absolute_monarchy",
            "Absolute Monarchy",
    ...
    public static final Ideology CONSTITUTIONAL_MONARCHY = new Ideology(
...
// --- ELITE GOVERNANCE ---
    ...
    public static final Ideology ARISTOCRACY = new Ideology(
            "aristocracy",
    ...
    public static final Ideology FEUDALISM = new Ideology(
            "feudalism",
            "Feudalism",
    ...
    public static final Ideology NEOFEUDALISM = new Ideology(
            "neofeudalism",
            "Neofeudalism",
...
// --- THEOCRACY ---
    ...
    public static final Ideology UNIVERSALIST_THEOCRACY = new Ideology(
    ...
    public static final Ideology PARTICULARIST_THEOCRACY = new Ideology(
...
// --- NATIONALISM ---
    ...
    public static final Ideology RELIGIOUS_NATIONALISM = new Ideology(
    ...
    public static final Ideology CIVIC_NATIONALISM = new Ideology(
            "civic_nationalism",
            "Civic Nationalism",
    ...
    public static final Ideology ETHNONATIONALISM = new Ideology(
            "ethnonationalism",
            "Ethnonationalism",
...
// --- AUTHORITARIAN / EXPANSIONIST ---
    ...
    public static final Ideology FASCISM = new Ideology(
            "fascism",
            "Fascism",
            ...
            new PoliticalCompass(-400, 400, 350, 450)
    );

    public static final Ideology COLONIALISM = new Ideology(
            "colonialism",
    ...
    public static final Ideology MILITARISM = new Ideology(
            "militarism",
            "Militarism",
...
// --- LIBERAL / PROGRESSIVE ---
    ...
    public static final Ideology SOCIAL_DEMOCRACY = new Ideology(
            ...
            new PoliticalCompass(150, -200, 250, -200)
    );
    ...
    public static final Ideology NEOLIBERALISM = new Ideology(
            ...
            new PoliticalCompass(375, -300, 350, 150)
    );
...
// --- SOCIALISM / COMMUNISM ---
    ...
    public static final Ideology AUTHORITARIAN_COMMUNISM = new Ideology(
            ...
            new PoliticalCompass(-450, -350, 350, 400)
    );
    ...
    public static final Ideology DEMOCRATIC_SOCIALISM = new Ideology(
            ...
            new PoliticalCompass(-150, -250, 100, -300)
    );
...
// --- ANARCHISM ---
    ...
    public static final Ideology INDIVIDUALIST_ANARCHISM = new Ideology(
...
// --- CONSERVATISM ---
    ...
    public static final Ideology TRADITIONAL_CONSERVATISM = new Ideology(
            ...
            new PoliticalCompass(-100, 200, 400, 250)
    );
    ...
    public static final Ideology REACTIONARY_CONSERVATISM = new Ideology(
            ...
            new PoliticalCompass(-200, 350, -200, 250)
    );

    public static final Ideology NEOCONSERVATISM = new Ideology(
            "neoconservatism",
            "Neoconservatism",
            ...
            new PoliticalCompass(150, -100, 350, 200)
    );
...
// They differ on universal/particular: right populism targets cosmopolitan elites on behalf of a cultural "people"; left populism targets capital on behalf of an economic "people".
    public static final Ideology RIGHT_POPULISM = new Ideology(
            "right_populism",
            "Right Populism",
            ...
            new PoliticalCompass(-150, 300, -400, -100)
    );

    public static final Ideology LEFT_POPULISM = new Ideology(
            "left_populism",
            "Left Populism",
...
// --- TECHNOCRACY ---
    ...
    public static final Ideology TECHNOCRACY = new Ideology(
            ...
            new PoliticalCompass(-100, -200, 450, 300)
    );

// --- ECONOMIC DOCTRINES ---

    public static final Ideology MERCANTILISM = new Ideology(
            "mercantilism",
            "Mercantilism",
...
// --- PRE-STATE ---
    ...
    public static final Ideology TRIBALISM = new Ideology(
            "tribalism",
            ...
            new PoliticalCompass(-300, 450, 150, 250)
    );
}
