...
public static final TenetGroup GOVERNMENT = builder(TGType.SORT_ONLY, HARD_CULTURE, "government", "GovernmentTenet", "");
    ...
    public static final TenetGroup ACADEMIC_CLASS = builder(TGType.CASTE_SYSTEM, CLASS_AND_CASTE, ImmutableList.of(CITIZENSHIP,CASTE_PERMEABILITY), "academic_class", "Academic Class", "");
    public static final TenetGroup ARTIST_CLASS = builder(TGType.CASTE_SYSTEM, CLASS_AND_CASTE, ImmutableList.of(CITIZENSHIP,CASTE_PERMEABILITY), "artist_class", "Artist Class", "");
    public static final TenetGroup OFFICER_CLASS = builder(TGType.CASTE_SYSTEM, CLASS_AND_CASTE, ImmutableList.of(CITIZENSHIP,CASTE_PERMEABILITY), "officer_class", "Officer Class", "");
