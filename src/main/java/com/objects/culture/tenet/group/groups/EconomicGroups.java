...
//
// ECONOMY
public static final TenetGroup ECONOMY = builder(TGType.SORT_ONLY, HARD_CULTURE, "economy", "Economy", "");

    // Pillars
    public static final TenetGroup ECONOMIC_SYSTEM = builder(TGType.PILLAR_SYSTEM, ECONOMY, "system", "Economic System", "");
    public static final TenetGroup ECONOMIC_IDEOLOGY = builder(TGType.PILLAR_IDEOLOGY, ECONOMY, ImmutableList.of(ECONOMIC_SYSTEM), "ideology", "Economic Ideology", "");

    // Economic System
    public static final TenetGroup STATE_ENTERPRISE = builder(TGType.SYSTEM_LARGE, ECONOMIC_SYSTEM, "enterprise", "Enterprise", "");
    public static final TenetGroup PRIVATE_ENTERPRISE = builder(TGType.SYSTEM_LARGE, ECONOMIC_SYSTEM, "private_enterprise", "Private Enterprise", "");
    public static final TenetGroup ECONOMIC_MOBILITY = builder(TGType.SYSTEM_LARGE, ECONOMIC_SYSTEM, ImmutableList.of(CLASS_AND_CASTE), "mobility", "Mobility", "");
    public static final TenetGroup PROPERTY_RIGHTS = builder(TGType.SYSTEM_LARGE, ECONOMIC_SYSTEM, ImmutableList.of(STATE_ENTERPRISE, PRIVATE_ENTERPRISE), "property_rights", "Property Rights", "");
    public static final TenetGroup RESOURCE_RIGHTS = builder(TGType.SYSTEM_LARGE, ECONOMIC_SYSTEM, ImmutableList.of(STATE_ENTERPRISE, PRIVATE_ENTERPRISE), "resource_rights", "Resource Rights", "");
    public static final TenetGroup LABOR_RIGHTS = builder(TGType.SYSTEM_LARGE, ECONOMIC_SYSTEM, ImmutableList.of(STATE_ENTERPRISE, PRIVATE_ENTERPRISE, CLASS_AND_CASTE, CIVIL_LIBERTIES), "labor_rights", "Labor Rights", "");
    public static final TenetGroup LABOR_UNIONS = builder(TGType.SYSTEM_LARGE, ECONOMIC_SYSTEM, ImmutableList.of(LABOR_RIGHTS, STATE_ENTERPRISE, PRIVATE_ENTERPRISE, CLASS_AND_CASTE, CIVIL_LIBERTIES), "labor_unions", "Labor Unions", "");
    public static final TenetGroup MILITARY_INDUSTRIAL_COMPLEX = builder(TGType.SYSTEM_LARGE, ECONOMIC_SYSTEM, ImmutableList.of(MILITARY, MILITARY_PROCUREMENT, MILITARY_FUNDING, GOVERNMENT_CORRUPTION), "military_industrial_complex", "Military Industrial Complex", "");
    public static final TenetGroup FOREIGN_INVESTMENT = builder(TGType.SYSTEM_LARGE, ECONOMIC_SYSTEM, ImmutableList.of(FOREIGN_POLICY), "foreign_investment", "Foreign Investment", "");

    // Economic Ideology
    public static final TenetGroup MERCHANT_TREATMENT = builder(TGType.BELIEF_MAJOR, ECONOMIC_IDEOLOGY, ImmutableList.of(MERCHANT_CLASS),"policy", "Economic Policy", "");
    public static final TenetGroup TRADE_ETHICS = builder(TGType.BELIEF_MAJOR, ECONOMIC_IDEOLOGY, "trade_ethics", "Trade Ethics", "");
    public static final TenetGroup ECONOMIC_VALUE = builder(TGType.VALUE, ECONOMIC_IDEOLOGY, "value", "Economic Value", "");
