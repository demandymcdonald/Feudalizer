...
public abstract class Tenet<TE extends Tenet<TE,TG>,TG extends TenetGroup> implements Displayable, SuperclassSerializable<Tenet<TE,TG>> {
    ...
    public Tenet(TenetGroup group, String id, String name, String description) {
        this.group = group;
        this.id = id;
        this.name = name;
