...
public class EduManager {
    ...
    public static final Education PRIMARY_SCHOOL_EDUCATION = new Education(
            EducationGroups.PRIMARY_SCHOOL_EDUCATION, 0,"primary", "Primary School Education",
    ...
    public static final Education SECONDARY_SCHOOL_EDUCATION = new Education(
            EducationGroups.SECONDARY_SCHOOL_EDUCATION, 1,"secondary", "Secondary School Education",
    ...
    public static final Education APPRENTICE_EDUCATION = new Education(
            EducationGroups.APPRENTICE_EDUCATION, 2,"apprenticeship", "Apprenticeship Education",
    ...
    public static final Education TECHNICAL_SCHOOL_EDUCATION = new Education(
            EducationGroups.TECHNICAL_SCHOOL_EDUCATION, 2,"technical", "Technical School Education",
    ...
    public static final Education UNDERGRADUATE_EDUCATION = new Education(
            EducationGroups.UNDERGRADUATE_EDUCATION, 3,"undergraduate", "Undergraduate Education",
    ...
    public static final Education GRADUATE_EDUCATION = new Education(
            EducationGroups.GRADUATE_EDUCATION, 4,"graduate", "Graduate Education",
    ...
    public static final Education DOCTORATE_EDUCATION  = new Education(
            EducationGroups.POST_GRADUATE_EDUCATION, 5,"doctor", "Doctorate",
    ...
    public static final Education LAWYER_EDUCATION = new Education(
            EducationGroups. POST_GRADUATE_EDUCATION, 6,"lawyer", "Legal Education",
    ...
    public static final Education MEDICAL_DOCTOR_EDUCATION = new Education(
            EducationGroups.POST_GRADUATE_EDUCATION, 6,"medical_doctor", "Medical Education",
    ...
    public static final Education PRIVATE_SCHOOL_PRIMARY_EDUCATION = new Education(
            EducationGroups.PRIVATE_SCHOOL_PRIMARY_EDUCATION, 0,"private_primary", "Private School Primary Education",
    ...
    public static final Education PRIVATE_SCHOOL_SECONDARY_EDUCATION = new Education(
            EducationGroups.PRIVATE_SCHOOL_SECONDARY_EDUCATION, 1,"private_secondary", "Private School Secondary Education",
    ...
    public static final Education RELIGIOUS_SCHOOL_PRIMARY_EDUCATION = new Education(
            EducationGroups.RELIGIOUS_SCHOOL_PRIMARY_EDUCATION, 0,"religious_primary", "Religious School Primary Education",
    ...
    public static final Education RELIGIOUS_SCHOOL_SECONDARY_EDUCATION = new Education(
            EducationGroups.RELIGIOUS_SCHOOL_SECONDARY_EDUCATION, 1,"religious_secondary", "Religious School Secondary Education",
    ...
    public static final Education OFFICER_EDUCATION = new Education(
            EducationGroups.OFFICER_EDUCATION,3, "officer", "Officer Training",
    ...
    public static final Education SOLDIER_BASIC_EDUCATION = new Education(
            EducationGroups.SOLDIER_BASIC_EDUCATION, 1,"basic", "Basic Training",
    ...
    public static final Education SOLDIER_TECHNICAL_EDUCATION = new Education(
            EducationGroups.SOLDIER_TECHNICAL_EDUCATION, 2,"soldier_technical", "Technical Training",
    ...
    public static final Education HOMESCHOOL_SCHOOL_PRIMARY_EDUCATION = new Education(
            EducationGroups.HOMESCHOOL_SCHOOL_PRIMARY_EDUCATION, 0,"homeschool_primary", "Homeschooled Primary Education",
    ...
    public static final Education HOMESCHOOL_SCHOOL_SECONDARY_EDUCATION = new Education(
            EducationGroups.HOMESCHOOL_SCHOOL_SECONDARY_EDUCATION, 1,"homeschool_secondary", "Homeschooled Secondary Education",
    ...
    public static final Education HOMESCHOOL_DOMESTIC_EDUCATION = new Education(
            EducationGroups.HOMESCHOOL_DOMESTIC_EDUCATION, 2,"domestic", "Domestic Education",
